  ...
  void showCustomDialog(List<Product> products, context) async {
    ...
    AlertDialog alertDialog = AlertDialog(
        ...
        MaterialButton(
          onPressed: () {
            try {
              Store _store = Store();
              _store.storeOrders(
                  {kTotallPrice: price, kPhone: phone}, products);
      ...
      content: TextField(
        ...
        decoration: InputDecoration(hintText: 'Enter Your Name & Phone no.'),
      ),
      // title: Text('Totall Price  = \$ $price'),
      title: Text('Totall Price  = e.g. $price'),
    );
    await showDialog(
        context: context,
        builder: (context) {
