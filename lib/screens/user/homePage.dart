          ...
          child: Scaffold(
            bottomNavigationBar: BottomNavigationBar(
              ...
              items: [
                ...
                //     title: Text('Shop'), icon: Icon(Icons.person)),
                BottomNavigationBarItem(
                    title: Text('k3 pro'), icon: Icon(Icons.account_balance)),
                BottomNavigationBarItem(
            ...
            body: TabBarView(
              children: <Widget>[
                jacketView(),
                ProductsView(kHandfree, _products),
                ProductsView(kCable, _products),
                ProductsView(kBattery, _products),
              ],
            ),
          ),
        ),
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          _products = [...products];
          products.clear();
          products = getProductByCategory(kCharger, _products);
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Text('e.g. ${products[index].pPrice}')
                              ],
                            ),
                          ),
                        ),
